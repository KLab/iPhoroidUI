...
public class TitleFlowIndicator extends TextView implements FlowIndicator {
    ...
    public TitleFlowIndicator(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator);
        // Retrieve the colors to be used for this view and apply them.
        int footerColor = a.getColor(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_footerColor, FOOTER_COLOR);
        footerLineHeight = a.getInt(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_footerLineHeight, FOOTER_LINE_HEIGHT);
        footerTriangleHeight = a.getInt(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_footerTriangleHeight, FOOTER_TRIANGLE_HEIGHT);
        int selectedColor = a.getColor(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_selectedColor, SELECTED_COLOR);
        int textColor = a.getColor(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_textColor, TEXT_COLOR);
        float textSize = a.getFloat(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_textSize, TEXT_SIZE);
        titlePadding = a.getInt(R.styleable.org_klab_iphoroid_widget_flowview_TitleFlowIndicator_titlePadding, TITLE_PADDING);
